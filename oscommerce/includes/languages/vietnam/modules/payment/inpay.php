 ...
 */
  ...
  define('MODULE_PAYMENT_INPAY_TEXT_TITLE', 'Inpay - instant online bank transfers - thanh toán trực tuyến lập tức');
  define('MODULE_PAYMENT_INPAY_TEXT_PUBLIC_TITLE', 'Thanh toán với ngân hàng trực tuyến của bạn - nhanh chóng và 100% an toàn');
...
With inpay there is no risk of credit card fraud or any kind of chargebacks. This means that when you get paid you stay paid! With inpay you can even sell to customers from \'high risk\' regions including all parts of Asia and Eastern Europe.<br /><br />
  ...
  // ------------- e-mail settings ---------------------------------
  define('EMAIL_TEXT_SUBJECT', 'Thanh toán được xác nhận bởi inpay');
  define('EMAIL_TEXT_ORDER_NUMBER', 'Số đơn hàng:');
  define('EMAIL_TEXT_INVOICE_URL', 'Chi tiết Invoice:');
  define('EMAIL_TEXT_DATE_ORDERED', 'Ngày đặt hàng:');
  define('EMAIL_TEXT_PRODUCTS', 'Sản phẩm');
  define('EMAIL_TEXT_SUBTOTAL', 'Tổng cộng:');
  define('EMAIL_TEXT_TAX', 'Thuế:        ');
  define('EMAIL_TEXT_SHIPPING', 'Vận chuyển: ');
  define('EMAIL_TEXT_TOTAL', 'Tổng cộng:    ');
  define('EMAIL_TEXT_DELIVERY_ADDRESS', 'Địa chỉ vận chuyển');
  define('EMAIL_TEXT_BILLING_ADDRESS', 'Địa chỉ thanh toán');
  define('EMAIL_TEXT_PAYMENT_METHOD', 'Phương thức thanh toán');
  define('EMAIL_SEPARATOR', '------------------------------------------------------');
  define('TEXT_EMAIL_VIA', 'với');
